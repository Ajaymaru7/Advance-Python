...
def show1():
    sel = "Horizontel Scale Value = " +str(v1.get())
...
b1 = Button(root, text = "Display Horizontal",command = show1, bg= "sky blue")


b2 = Button(root, text = "Display Vertical",command = show2, bg= "Green")
